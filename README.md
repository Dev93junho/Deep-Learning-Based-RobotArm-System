...
<p align="center"><img src="./readmeData/Trajectory_test.png" width="45%" height="30%" alt="result0"><img src="./readmeData/octomapping.png" width="45%" height="30%" alt="result1"><img src="./readmeData/mapping data.png" width="40%" height="15%" alt="result2"></p>
