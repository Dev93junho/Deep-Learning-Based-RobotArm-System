...
<p align="center"><img src="./readmeData/Trajectory_test.png" width="35%" height="20%" alt="result0"><img src="./readmeData/octomapping.png" width="35%" height="20%" alt="result1"><img src="./readmeData/mapping data.png" width="30%" height="15%" alt="result2"></p>
