...
<p align="center"><img src="./readmeData/Trajectory_test.png" width="35%" alt="result0"><img src="./readmeData/octomapping.png" width="35%" alt="result1"><img src="./readmeData/mapping data.png" width="30%" alt="result2"></p>
